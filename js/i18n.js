export const copy = {
  en: {
    ...
    'title.role': 'Gameplay & Systems Programmer',
  ...
  pt: {
    ...
    'title.role': 'Programador de Gameplay e Sistemas',
    ...
    'ro.parity': 'Paridade',
    'ro.rooms': 'Salas',
    'ro.dmg': 'Tipos de dano',
    'ro.tiers': 'Níveis de torre',
    'ro.cmds': 'Comandos',
    'ro.deps': 'Deps. da engine',

    'sv.title': 'Steam Veins',
    'sv.credit': 'Steam, ago 2025, Kimu Studios',
    ...
    'ro.sv.role': 'Combate dos inimigos',
    'ro.sv.audio': 'FMOD',

    'mm.title': 'MidNight Memories',
    'mm.credit': 'Estande da BGS 2026, dupla, lidero o código',
    ...
    'hk.title': "Hell's Kitchen",
    'hk.credit': 'Equipe independente, Unity 6',
    ...
    'dg.title': 'Dino Girls',
    'dg.credit': 'Kimu Studios, programador de gameplay',
...
function apply(lang) {
  ...
  // The HUD composes its own label from stage titles, so it re-reads them here.
